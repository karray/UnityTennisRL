...
N_STEPS_LEARN = 20      # train each n step
...
class MultiAgent():
    ...
    def __init__(self, state_size, action_size, n_agents, random_seed=0):
        ...
        self.agents = [Agent(state_size, action_size, random_seed) for p in range(n_agents)]
    ...
    def learn(self):
        ...
        if len(self.memory) > BATCH_SIZE:
            for angent in self.agents:
                angent.learn(self.memory.sample(), GAMMA)
